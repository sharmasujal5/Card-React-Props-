  ...
  return (
    <div className="parent">
      {jobOpenings.map(function(elem){
        return <Card company={elem.companyName} post={elem.post} tag1={elem.tag1} tag2={elem.tag2} datePstd={elem.datePosted} pay={elem.pay} location={elem.location} img={elem.brandLogo}/>
      })}
    </div>
  );
};
